...
//  FoodTrackerLAB2
//
//  Created by iosdev on 29/01/2019.
...
class MealTableViewController: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        //Because we created a custom cell class that we want to use, downcasting the type of cell to our custom cell subclass, MealTableViewCell
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        case "ShowDetail":
            ...
            guard let indexPath = tableView.indexPath(for: selectedMealCell) else {
                fatalError("The selected cell is not beinf displayed by the table")
            }
